            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="cidade" type="text" name="cidade" value="<?php echo set_value('cidade'); ?>Palmares Paulista"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="estado" type="text" name="estado" value="<?php echo set_value('estado'); ?>SP"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="cep" type="text" name="cep" value="<?php echo set_value('cep'); ?>15828000"  />
                        </div>
                    </div>
