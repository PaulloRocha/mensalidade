<div class="span12" style="margin-left: 0; margin-top: 0">
    <div class="span12" style="margin-left: 0">
        ...
        <div class="span10" style="margin-left: 0">
            <input type="text" class="span12" name="termo" placeholder="Digite o nome do aluno ou o número de sua matrícula" />
        </div>
        <div class="span2">
...
if (isset($_POST['pagar'])) {
	...
	$aluno = $_POST['aluno'];
		...
		$sql4 = mysql_query("INSERT INTO `lancamentos` VALUES ('','Mens. $primeiroNome $ultimoNome <strong>[id $id]</strong>','".$valor."','".$data_atual."','1','$nome_emitente','Dinheiro','receita','1','1')");
		
		if ($sql && $sql2 && $sql3 && $sql4){$this->session->set_flashdata('success','Mensalidade lançada com sucesso!');
		redirect('mapos/pesquisarAluno?termo='.$id);
		}
}
...
if(isset($_GET['termo'])) {
	...
	$seleciona = mysql_query("SELECT * FROM mensalidades INNER JOIN clientes ON idClientes = clientes_id WHERE ano = ".$anoselecionado." AND (clientes.nomeCliente LIKE '%$termo_pesquisado%' OR id = '".$termo_pesquisado."') ORDER by id DESC");
